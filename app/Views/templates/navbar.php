    ...
    <header>
        <nav class="navbar navbar-expand navbar-light navbar-top" id="navbarCollapse">
            <div class="container-fluid">
                ...
                <!-- Tambahkan class 'no-ajax' di sini -->
                <a href="javascript:void(0)" class="burger-btn d-block no-ajax">
                    <i class="bi bi-justify fs-3"></i>
                </a>

                <button class="navbar-toggler no-ajax" type="button" data-bs-toggle="collapse"
                    data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                    aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                    ...
                    <ul class="navbar-nav ms-auto mb-lg-0">
                        ...
                        <li class="nav-item dropdown me-3">
                            ...
                            <ul class="dropdown-menu dropdown-center  dropdown-menu-sm-end notification-dropdown" aria-labelledby="dropdownMenuButton">
                                ...
                                <li class="dropdown-item notification-item d-none">

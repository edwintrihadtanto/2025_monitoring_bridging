...
<div id="sidebar">
    <div class="sidebar-wrapper active">
                ...
                <li class="sidebar-item has-sub m-0">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="<?= site_url('monitoring') ?>" class="submenu-link" data-page="monitoring">Logs Monitoring</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="theme-toggle d-flex gap-2 m-2" style="bottom: 0; right: 0; position: absolute;">

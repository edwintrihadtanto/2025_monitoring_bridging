...
class BpjsVclaim_InsertService
{
    ...
    {
        $this->baseUrl   = env('BPJSVCLAIM.api.baseURL');
        $this->consId    = env('BPJSVCLAIM.ConsID');
        $this->secretKey = env('BPJSVCLAIM.SekretKey');
        $this->userKey   = env('BPJSVCLAIM.UserKey');
